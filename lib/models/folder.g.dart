...
extension FolderQueryWhere on QueryBuilder<Folder, Folder, QWhereClause> {
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> updatedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Folder, Folder, QAfterWhereClause> updatedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'updatedAt',
        lower: [null],
